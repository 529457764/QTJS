	...
	<section data-role="page" data-title="产品分类" id="product">
		...
		<div data-role="content">
			<ul data-role="listview" class="navsBar">
				<li>
					<a href="/servlet/wap/WapEnter?handle=showProduct&productTypeId=3" class="navs nav1">
						<i class="icon message-icon">&#xe606;</i>
						<h2 class="longContent icon-title">电脑计算机</h2>
					</a>
				</li>
				<li>
					<a href="/servlet/wap/WapEnter?handle=showProduct&productTypeId=2" class="navs nav2">
						<i class="icon service-icon">&#xe605;</i>
						<h2 class="longContent icon-title">打印机</h2>
					</a>
				</li>
				<li>
					<a href="/servlet/wap/WapEnter?handle=showProduct&productTypeId=1" class="navs nav3">
						<i class="icon product-icon">&#xe601;</i>
						<h2 class="longContent icon-title">扫描仪</h2>
					</a>
				</li>
				<li>
					<a href="/servlet/wap/WapEnter?handle=showProduct&productTypeId=5" class="navs nav4">
